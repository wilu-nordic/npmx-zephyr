...
The npmx BUCK sample demonstrates how to control PMIC LEDs using npmx drivers.
...
This sample uses the npmx LED driver to blink LEDs according to the sequence defined in the main function.
...
#. |connect_kit|
#. |connect_terminal|
#. See blinking LEDs on the board.
