...
The npmx shell sample allow to use zephyr shell to control PMIC device.
...
* Configure npmx shell driver.
* Initialize and register POF callback.
...
.. |sample path| replace:: :file:`samples/pmic/shell`
