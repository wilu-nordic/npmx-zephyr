...
The npmx VBUSIN sample demonstrates how to receive messages about connected power supply based on USB CC lines status.
...
#. |connect_terminal|
#. Connect the battery.
#. Connect and disconnect various USB power supplies to J3 to see messages about the power supply current.
