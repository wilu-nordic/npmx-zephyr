...
The npmx simple sample demonstrates how to setup charger, LEDs and USB CC messages.
...
This sample uses the npmx drivers to do the following:
...
.. |sample path| replace:: :file:`samples/pmic/simple`
